...
AstroBabyDoge is built upon the fundamentals of Buyback and increasing the investor's value
    
Main features are
    
1) 2% tax is collected and distributed to holders for HODLing
2) 11% buyback and marketing tax is collected and 3% of it is sent for marketing fund and othe 8% is used to buyback the tokens
    https://astrobabydoge.com
    https://t.me/astrobabydoge
*/
...
contract AstroBabyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6bCE8B8D693720Ae57Ce1eDee0089D313Fd4c423); // Marketing Address
    ...
    string private _name = "AstroBabyDoge";
    string private _symbol = "ABD";
    ...
    function triggerWhaleBuyback(uint256 amount) external onlyOwner {
